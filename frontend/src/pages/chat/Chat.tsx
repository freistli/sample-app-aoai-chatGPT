                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer your questions. The responses are generated by AI, check references info and ensure the answers are okay</h2>
                            </Stack>
                        ) : (
